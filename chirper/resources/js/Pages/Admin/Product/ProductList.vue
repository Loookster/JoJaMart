...
const dialogProductvisible = ref('');
const published = ref('');
                    ...
                    <form @submit.prevent="editMode ? updateProduct(): AddProduct()">
                        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <textarea id="description" v-model="description" rows="8"
                            ...
                            <tr v-for="(product, index) in products" :key="product.id" class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3">
                                    <span v-if="product.inStock == 1"
                                        class="bg-green-100 text-green-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-green-900 dark:text-green-300">Has
                                        Stock</span>
                                    <span v-else="product.inStock == 0"
